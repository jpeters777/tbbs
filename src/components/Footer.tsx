    ...
    <footer className="bg-[var(--color-bg-dark)] text-[var(--color-text-on-dark)]">
      <div className="container py-14 grid gap-10 md:grid-cols-4">
        <div className="md:col-span-1">
          <p className="text-2xl mb-3" style={{ fontFamily: "var(--font-display)" }}>
            {siteConfig.brand}
          </p>
          <p className="text-sm text-white/70 mb-4">
            Personalized cosmetic surgery guidance across Tampa Bay and beyond.
          </p>
          <a href={siteConfig.phoneHref} className="block font-semibold mb-2">
            {siteConfig.phone}
          </a>
          <a href={`mailto:${siteConfig.email}`} className="block text-sm text-white/80">
            {siteConfig.email}
          </a>
        </div>

        <div>
          <h3 className="text-lg mb-3">Procedures</h3>
        ...
        <div>
          ...
          <div className="flex flex-col gap-3 text-sm">
            ...
            <a href={siteConfig.paymentUrl} className="hover:text-[var(--color-accent)]" target="_blank" rel="noreferrer">
              Make a payment
            </a>
            <a href={siteConfig.social.instagram} className="hover:text-[var(--color-accent)]" target="_blank" rel="noreferrer">
              Instagram
            </a>
            <a href={siteConfig.social.facebook} className="hover:text-[var(--color-accent)]" target="_blank" rel="noreferrer">
              Facebook
            </a>
          </div>
        </div>
      ...
      <div className="border-t border-white/10">
        <div className="container py-4 text-xs text-white/55 flex flex-col sm:flex-row gap-2 sm:justify-between">
