...
export const outOfTownPatientGuidePage: CuratedPageContent = createCuratedPage({
    ...
    steps: [
      {
        ...
        body: "Many patients begin with a virtual consultation to discuss goals, share their own photos for assessment, review their provider's before & after portfolio with their provider, and receive personalized procedure recommendations from an experienced provider within our network.",
      },
      {
        step: "02",
  ...
  faqs: [
    ...
    },
    {
      ...
      a: "Yes. Many patients begin with a virtual consultation before traveling to Tampa—where you can share your own photos, review your provider's before & after portfolio with your provider, and discuss next steps.",
    },
    {
