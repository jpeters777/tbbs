...
export const faqsPage: CuratedPageContent = createCuratedPage({
  ...
  faqs: [
    ...
    },
    {
      ...
      a: "Yes, virtual consultations are available for many body contouring and cosmetic surgery procedures. You can discuss goals, share your own photos for assessment, review your provider's before & after portfolio with your provider, and begin planning remotely before traveling to Tampa Bay.",
    },
    {
