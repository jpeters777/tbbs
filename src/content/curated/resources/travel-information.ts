...
export const travelInformationPage: CuratedPageContent = createCuratedPage({
    ...
    steps: [
      {
        ...
        body: "Begin remotely to discuss goals, share your own photos for assessment, review your doctor's before & after portfolio with your doctor, and receive personalized procedure recommendations. Many traveling patients complete this step before booking flights.",
      },
      {
        step: "02",
  ...
  faqs: [
    ...
    },
    {
      ...
      a: "Yes. Virtual consultations allow you to discuss goals, share your own photos for assessment, review your doctor's before & after portfolio with your doctor, and begin planning before booking travel.",
    },
    {
