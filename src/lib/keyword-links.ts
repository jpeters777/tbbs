...
export const HOMEPAGE_KEYWORD_LINKS: KeywordLink[] = [
  ...
  { text: "Adult circumcision", href: "/adult-circumcision" },
  { text: "penile width and girth", href: "/pwag" },
  { text: "Penile Width And Girth", href: "/pwag" },
  { text: "PWAG", href: "/pwag" },
  { text: "pwag", href: "/pwag" },
  ...
  { text: "Liposuction", href: "/liposuction" },
  { text: "liposuction in Tampa", href: "/liposuction" },
  { text: "Liposuction in Tampa", href: "/liposuction" },
  { text: "liposuction Tampa", href: "/liposuction" },
  { text: "arm lipo tampa", href: "/arm-lipo-360-arm-lift" },
  { text: "Arm lipo Tampa", href: "/arm-lipo-360-arm-lift" },
